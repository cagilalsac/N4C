...
namespace APP.Features.Products
{
    ...
    {
        public ProductCreateHandler(IDb db, HttpService httpService, ILogger<Service> logger) : base(db, httpService, logger)
        {
        }

        public override Result<ProductCreateRequest> Validate(ProductCreateRequest request, ModelStateDictionary modelState = null, string errorMessagesSeperator = "; ")
        {
