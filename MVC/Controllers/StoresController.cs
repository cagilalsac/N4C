...
namespace MVC.Controllers
{
    ...
    public class StoresController : MvcController
    {
        ...
        public async Task<IActionResult> Index(PageOrder pageOrder)
        {
            ...
            var result = pageOrder is null ? await _storeService.List() : await _storeService.List(pageOrder);
        ...
        {
            // Get item logic:
            var result = await _storeService.Item(id);
        ...
        {
            var result = _storeService.ItemForCreate();
            SetViewData();
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            var result = await _storeService.ItemForEdit(id);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            var result = await _storeService.ItemForDelete(id);
