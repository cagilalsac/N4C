...
namespace MVC.Controllers
{
    ...
    public class ProductsController : MvcController
    {
        ...
        )
        {
            ...
            //_httpService.Set(config => config.ApiUri = "products");
        }
        ...
        void SetViewData(Result result, PageOrder pageOrder = default)
        {
            ...
            ViewBag.CategoryId = new SelectList(_categoryService.Get().Result.Data, "Id", "Name");

            /* Can be uncommented and used for many to many relationships. Entity must be replaced with the related name in the controller and views. */
            ViewBag.StoreIds = new MultiSelectList(_StoreService.Get().Result.Data, "Id", "Name");
        ...
        public async Task<IActionResult> Index(PageOrder pageOrder)
        {
            ...
            var result = await _httpService.Get<ProductResponse>() ?? await _productService.Get(pageOrder);
        ...
        {
            var result = _productService.GetForCreate();
            SetViewData(result);
        ...
        public IActionResult Edit(int id)
        {
            ...
            var result = _productService.GetForEdit(id);
        ...
        public IActionResult Delete(int id)
        {
            ...
            var result = _productService.GetForDelete(id);
