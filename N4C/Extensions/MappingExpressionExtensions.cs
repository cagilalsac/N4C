...
namespace N4C.Extensions
{
    ...
    {
        public static IMappingExpression<TSource, TDestination> Map<TSource, TDestination>(this MapperProfile mapperProfile)
        {
            return mapperProfile.CreateMap<TSource, TDestination>();
        }
