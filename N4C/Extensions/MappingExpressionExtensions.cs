...
namespace N4C.Extensions
{
    ...
    {
        public static IMappingExpression<TSource, TDestination> Map<TSource, TDestination>(this MapConfig mapConfig)
        {
            return mapConfig.CreateMap<TSource, TDestination>();
        }
