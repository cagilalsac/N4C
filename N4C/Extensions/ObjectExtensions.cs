...
namespace N4C.Extensions
{
    public static class ObjectExtensions
    {
        ...
        public static TDestination Map<TSource, TDestination>(this TSource source, MapConfig mapConfig = default, TDestination destination = default) where TSource : class, new() where TDestination : class, new()
        {
            var mapperConfigurationExpression = new MapperConfigurationExpression();
            mapperConfigurationExpression.CreateMap<TSource, TDestination>();
            if (mapConfig is not null)
                mapperConfigurationExpression.AddProfile(mapConfig);
