...
namespace N4C.Users.Web.ApiControllers
{
    ...
    public class N4CStatusesController : ApiController<N4CStatus, N4CStatusRequest, N4CStatusResponse>
    {
		...
		// POST: N4CStatuses
        [HttpPost]
        public override async Task<IActionResult> Post([FromBody] N4CStatusRequest request)
        {
        ...
        // PUT: N4CStatuses
        [HttpPut]
        public override async Task<IActionResult> Put([FromBody] N4CStatusRequest request)
        {
            request.Set(ModelState);
